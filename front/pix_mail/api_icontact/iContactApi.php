...
class iContactApi {
	...
	**/
	 ...
	 * @return object
	**/
	public function addContact($sEmail, $values, $sStatus = 'normal') {
		// Valid statuses
	 ...
	 * @return object
	**/
	public function addContact2($sEmail, $sStatus = 'normal', $sPrefix = null, $sFirstName = null, $sLastName = null, $sSuffix = null, $sStreet = null, $sStreet2 = null, $sCity = null, $sState = null, $sPostalCode = null, $sPhone = null, $sFax = null, $sBusiness = null) {
		// Valid statuses
		$aValidStatuses = array('normal', 'bounced', 'donotcontact', 'pending', 'invitable', 'deleted');
		// Contact placeholder
		$aContact       = array(
